...
from optimize import Super_human
...
if __name__ == "__main__":
    ...
    if noise==False:
        noise_ratio = 0.0
    sh_obj = Super_human(dataset, num_of_demos, feature, num_of_features, lr_theta, noise, noise_ratio, demo_baseline, base_model_type, model_obj)
    if noise==False:
        noise_ratio = 0.0
