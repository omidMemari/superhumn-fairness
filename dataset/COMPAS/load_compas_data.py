...
def create_dataset_ref():
    # df1 = pd.read_csv("compas_A.csv", sep=r'\t', engine='python')
    df2 = pd.read_csv("compas_X.csv", sep=r'\t', engine='python')
    df3 = pd.read_csv("compas_Y.csv", sep=r'\t', engine='python')
    # df = pd.concat([df1, df2, df3], axis=1)
    df = pd.concat([df2, df3], axis=1)
    df.to_csv("dataset_ref.csv")
